...
def transform_data(processed_df, processed_teams_df, data_processing, feature_columns):
    """
...
def calculate_power_rank(df_home, df_away, metrics_home, metrics_away, weights):
    """
...
def aggregate_and_normalize_data(df, cleaned_metrics, database_operations, processed_teams_df):
    """
...
def insert_aggregated_data_into_database(aggregated_df, database_operations):
    """
